  ...
  render() {
    if (!this.state.webglAvailable || this.state.hasError) {
      return this.props.fallback || (
        <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-background-primary to-background-secondary/50 overflow-hidden">
          ...
          <div className="text-center p-8 relative z-10">
            <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-br from-accent-primary/20 to-accent-secondary/20 flex items-center justify-center shadow-glow">
            ...
            <h3 className="text-h3 font-semibold text-text-primary mb-3">3D Scene Unavailable</h3>
