...
const StudioWork = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: 'web',
      categoryName: 'Web Development',
      description: 'Construction company showcase with project gallery and bilingual support.',
    ...
    },
    {
      ...
      description: 'Minimalist logo design for tech startup with full brand guidelines.',
    ...
    },
    {
      ...
      category: 'design',
      categoryName: 'Graphic Design',
      description: 'Complete design system with UI components and UX guidelines.',
    ...
    },
    {
      ...
      category: 'design',
      categoryName: 'Graphic Design',
      description: 'Creative social media assets and campaign materials.',
  ...
  return (
    <section
      ref={elementRef}
      id="work"
      className="relative py-40 bg-background-primary"
      ...
      <div className="container mx-auto px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full glass border border-border-subtle mb-8">
            <span className="text-small text-text-secondary">Our Work</span>
          </div>
          <h2 id="work-heading" className="text-h2-sm md:text-h2 lg:text-h1 font-bold text-text-primary mb-8">
            Featured Projects
          </h2>
              ...
              >
                <Card className="group overflow-hidden border-border-subtle hover:border-accent-primary/50 transition-all duration-700 hover:-translate-y-2 hover:shadow-glow">
                  <div className="relative aspect-video bg-gradient-to-br from-background-tertiary to-background-secondary overflow-hidden">
                    ...
                    <Badge className="absolute top-6 left-6 bg-accent-primary text-white border-none z-10">
                      {project.categoryName}
                    </Badge>
                  </div>

                  <CardContent className="p-10">
                    <h3 className="text-h4 font-semibold text-text-primary mb-4 group-hover:text-accent-primary transition-colors">
                      {project.title}
                    </h3>
