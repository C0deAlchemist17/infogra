      ...
      <div className="container mx-auto px-8 relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-small text-text-secondary">Let&apos;s Talk</span>
          </motion.div>
          ...
          <p className="text-body-lg md:text-h4 lg:text-h3 text-text-secondary mb-16 max-w-3xl mx-auto leading-relaxed">
            Whether you need a stunning website, a powerful e-commerce platform, or a complete digital transformation — we&apos;re here to make it happen.
          </p>
