...
import { 
  Code, Smartphone, Database, Cloud, Brain, Palette, Cpu
} from 'lucide-react'
...
const Technologies = () => {
  ...
  const techCategories = [
    ...
    },
    {
      icon: Palette,
      title: 'Design',
      techs: ['Figma', 'Adobe XD', 'Motion Design', '3D Modeling', 'Brand Identity'],
      ...
      <div className="container mx-auto px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full glass border border-border-subtle mb-8">
            ...
            <span className="text-small text-text-secondary">Our Stack</span>
          </div>
                ...
                <CardContent className="p-10">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {category.techs.map((tech) => (
                      <span
                        key={tech}
                        className="px-4 py-2 rounded-full text-small text-text-secondary glass border border-border-subtle hover:border-accent-primary/50 hover:text-accent-primary transition-all duration-300 cursor-default"
                      >
                        {tech}
                      </span>
                    ))}
