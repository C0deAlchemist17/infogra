  ...
  const testimonials = [
    {
      ...
      content: 'INFOGRA transformed our digital presence completely. Their attention to detail and technical expertise is unmatched. The new platform increased our conversions by 200%.',
      rating: 5,
      avatar: 'AH'
    },
    {
      ...
      content: 'Working with INFOGRA was an absolute pleasure. They understood our vision perfectly and delivered a website that exceeded our expectations. Highly recommended!',
      rating: 5,
      avatar: 'SK'
    },
    {
      ...
      content: 'The e-commerce platform INFOGRA built for us is phenomenal. Performance, design, and functionality are all world-class. Our sales have tripled since launch.',
      rating: 5,
      avatar: 'MF'
    },
    {
      ...
      content: 'From concept to execution, INFOGRA delivered excellence. Their Three.js integration and animations are incredibly impressive. A true digital partner.',
      rating: 5,
      avatar: 'NI'
    }
  ]
      ...
      <div className="container mx-auto px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full glass border border-border-subtle mb-8">
            <span className="text-small text-text-secondary">Testimonials</span>
          </div>
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all duration-300 ${
                  index === activeIndex ? 'bg-accent-primary w-8' : 'bg-border-subtle hover:bg-accent-primary/50'
                }`}
              />
            ))}
          </div>
